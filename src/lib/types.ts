...
export type { Animal, Record, Photo, Asset, Species, CarerProfile, CarerTraining, HygieneLog, IncidentReport, ReleaseChecklist, OrgMember, SpeciesGroup, CoordinatorSpeciesAssignment, AnimalReminder, PermanentCareApplication, AnimalTransfer, PermanentCareApproval, PostReleaseMonitoring } from '@prisma/client';
